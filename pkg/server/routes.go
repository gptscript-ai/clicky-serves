...
func listTools(w http.ResponseWriter, r *http.Request) {
	...
	writeResponse(w, map[string]any{"tools": out})
}
...
func listModels(w http.ResponseWriter, r *http.Request) {
	...
	writeResponse(w, map[string]any{"models": out})
}
...
func execToolHandler(process func(ctx context.Context, l *slog.Logger, w http.ResponseWriter, opts gptscript.Opts, tool *gptscript.Tool)) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		process(ctx, ccontext.GetLogger(r.Context()), w, reqObject.Opts, &reqObject.Tool)
	}
}
...
func execFileHandler(process func(ctx context.Context, l *slog.Logger, w http.ResponseWriter, opts gptscript.Opts, path, input string)) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		process(ctx, ccontext.GetLogger(r.Context()), w, reqObject.Opts, reqObject.File, reqObject.Input)
	}
}
